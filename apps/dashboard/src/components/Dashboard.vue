        ...
        <DataTable :value="products" class="p-datatable-customers" :rows="5" style="margin-bottom: 20px" :paginator="true">
          <Column field="logo">
            ...
            <template #body="slotProps">
              <img :src="slotProps.data.logo" :alt="slotProps.data.name" width="50" />
            </template>
          </Column>
...
export default {
  ...
  data() {
    return {
      ...
      events: null,
      products: Array.from(Array(1000).keys()).map((i) => {
        const logos = [
